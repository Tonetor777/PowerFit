...
const Products = () => (
  <div className="p-8 px-32">
    ...
    <div className='w-[80%] mx-auto flex flex-wrap bg-zinc-800 gap-4 justify-between'>
      <div className='w-1/2  p-6 '>
        <h2 className="text-3xl font-bold mb-4 text-yellow-500">Lat Pulldown Machine</h2>
        <p className='text-white text-justify text-lg'>Our Lat Pulldown Machine is designed to help you build upper body strength and improve your posture. It features adjustable weights and a comfortable seat to accommodate users of all fitness levels. With every pull, you generate clean energy that can be used to power your home or gym.</p>
      </div>
